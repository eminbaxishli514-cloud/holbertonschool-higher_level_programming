...
including methods to calculate area, perimeter, string representation,
and a __repr__ method suitable for eval().
"""
...
class Rectangle:
    ...
    def __repr__(self):
        """Return a string representation for eval() to recreate a new instance."""
